...
export const APP_VERSION = '1.8.8b';
export const APP_NAME = 'PolisRoad';

// Versioni dei Database
export const DB_VERSION_CDS = '1.0.0 (Maggio 2026)';
export const DB_VERSION_PRONTUARIO = '2026.1 (giugno 2026)';
export const SYSTEM_STATUS = 'Operativo';
